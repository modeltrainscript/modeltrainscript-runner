...
public:
    ...
    static const uint32_t CAN_DETECTOR                  = 0x00080000L;
};
...
public:
    ...
    static const uint16_t CAN_DETECTOR                  = 0xC4;
    static const uint16_t CAN_DEVICE_GET_DESCRIPTION    = 0xC8;
    static const uint16_t CAN_DEVICE_SET_DESCRIPTION    = 0xC9;
    static const uint16_t CAN_BOOSTER_SET_TRACKPOWER    = 0xCB;
